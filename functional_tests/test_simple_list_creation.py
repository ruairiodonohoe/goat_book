"""Test Django NewVisitor list creation."""
...
class NewVisitorTest(FunctionalTest):
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self) -> None:
        ...
        # She notices that her list has a unique UR
        edith_list_url = self.browser.current_url
        self.assertRegex(edith_list_url, "/lists/.+")

        # Now a new user, Francis, comes along to the site.
        ## We delete all the browser's cookies as a way of simulating a brand new user session
